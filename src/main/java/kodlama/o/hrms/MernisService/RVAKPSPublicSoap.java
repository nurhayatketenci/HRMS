...
public class RVAKPSPublicSoap
{
    ...
    public RVAKPSPublicSoap(){}

    public RVAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RVAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RVAExtendedSoapSerializationEnvelope envelope= new RVAExtendedSoapSerializationEnvelope(RVAExtendedSoapSerializationEnvelope.VER11);
