...
public class RVAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RVADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RVAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RVADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RVADateTimeConverter dateTimeConverter = new RVAStandardDateTimeConverter();

    public RVAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RVAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RVAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RVAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RVAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RVAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
